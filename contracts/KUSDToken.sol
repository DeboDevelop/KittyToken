...
contract KUSDToken is ERC20Capped, ERC20Burnable {
    address payable public owner;
    uint256 public blockReward;
    constructor(uint256 cap, uint256 initialMint, uint256 reward) ERC20("KUSDToken", "KUSD") ERC20Capped(cap * (10 ** decimals())) {
